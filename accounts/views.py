...
from .forms import UserLoginForm, UserRegisterForm, AudioFileForm, SettingForm
...
def view_home(request):
    ...
    return render(request, 'home.html', {'page_title': title, 'form_login': form_login, 'form_register': form_register,
                                         'form_upload': form_upload,'form_button' : form_button,
